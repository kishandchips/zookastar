<?php
/**
 * zookastar functions and definitions
 *
 * @package zookastar
 * @since zookastar 1.0
 */
...
if ( ! function_exists( 'zookastar_setup' ) ):
/**
...
function zookastar_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'zookastar' ),
		'footer' => __( 'Footer Menu', 'zookastar' )
	) );

	add_image_size( 'gallery', 600, 9999);
 ...
 // 		array(
 // 			'rewrite' => array( 'with_front' => false, 'slug' => get_page_uri(get_zookastar_option('companies_page_id')) ),
...
add_action( 'after_setup_theme', 'zookastar_setup' );
 ...
 * @since zookastar 1.0
 */
function zookastar_widgets_init() {

	/********************** Sidebars ***********************/

	register_sidebar( array(
		'name' => __( 'Default Sidebar', 'zookastar' ),
		'id' => 'default',
...
function get_zookastar_option($option){
	$options = get_option('zookastar_theme_options');
